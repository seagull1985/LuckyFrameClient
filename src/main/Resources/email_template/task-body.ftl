...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" >
	...
	<table width="620" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="40" colspan="2" style="font-size:12px; text-indent:25px;"><div style="margin: 0px auto; padding: 0px 10px; width: 680px;">
			...
			<strong style="margin-bottom: 15px; display: block;">亲爱的Tester： 您好！以下是自动化任务【${jobname}】执行情况。</strong>
			...
			<br>
			<p><b>具体详情请点击：  </b><a href='http://${webip}:${webport}/caseDetail/list.do?tastId=${taskid}' target='任务查询'>查询本次自动化任务执行结果明细</a></p>
  ...
  <tr>
    <td height="30" align="center" bgcolor="#E3E3E3" style="font-size:12px; color:#666;">Copyright &copy; &nbsp;&nbsp;<a href='http://www.luckyframe.cn'>LuckyFrame</a>&nbsp;&nbsp;
	2017-2099 All Right Reserved </td>
  </tr>
</table>
</body>
</html>
