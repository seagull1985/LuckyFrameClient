...
<p align="center">
  ...
  <a href="http://git.oschina.net/seagull1985/LuckyFrameWeb/releases">
   <img src="https://img.shields.io/badge/LuckyFrame-V2.5 releases-green.svg" >
  </a>
</p>
...
- **接口+Web UI+移动端**：支持接口+Web UI+移动端自动化，客户端OS必须为Windows系统，UI、移动端自动化采用WebDriver3.0+appium封装，纯关键字驱动，0编码。
